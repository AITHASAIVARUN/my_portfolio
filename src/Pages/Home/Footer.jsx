  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/_saivarun_aitha?igsh=MWI5dzVnZG1kcnIyMA=="
            ...
            <li>
              <a
                href="https://x.com/saivarunaitha1?t=-Yh_l-9VdP6PFvMbsmnf1w&s=09"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/saivarun-aitha/?originalSubdomain=in"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with heavy efforts by Varun</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
